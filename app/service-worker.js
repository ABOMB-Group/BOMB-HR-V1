const CACHE='bombhr-employee-v139';
const CORE=['./','./index.html','./manifest.webmanifest','./pwa-install.js','./emergency-leave.js','./emergency-leave.css','./attendance-rules.js','./app-icon.svg','../assets/bombhr-logo.png'];
