...
(function(){
 ...
 function startEdit(){if(!canEditMonth())return;editMode=true;draft=JSON.parse(JSON.stringify(read()));refreshView()}
 function cancelEdit(){editMode=false;draft=null;toast('已取消，班表未變更');refreshView()}
