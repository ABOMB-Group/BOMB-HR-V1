...
(function(){
 ...
 schedulingView=function(){const html=baseSchedulingView();return html.replace('<div class="schedule-toolbar">',policyView()+inbox()+'<div class="schedule-toolbar">')};
 ...
 bindView=function(route){
   priorBind(route);
   if(route==='scheduling')setTimeout(()=>{document.querySelectorAll('[data-apply-preference]').forEach(button=>button.onclick=()=>applyPreference(button.dataset.applyPreference));bindPolicy()},0);
 };
