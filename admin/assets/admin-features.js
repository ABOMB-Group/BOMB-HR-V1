...
(function(){
 ...
 function enhance(){
  ...
  if(currentRole()==='executive'&&active&&!active.protected&&ui.role!=='owner'&&!document.querySelector('[data-delete-identity]')){const head=document.querySelector('.permission-role-head');if(head)head.insertAdjacentHTML('beforeend','<button class="secondary-btn identity-delete-btn" data-delete-identity="'+ui.role+'">刪除身份群組</button>')}
 ...
 document.addEventListener('click',createIdentityDirect,true);
